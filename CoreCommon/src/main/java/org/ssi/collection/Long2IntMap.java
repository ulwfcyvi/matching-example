...
public class Long2IntMap {	
	...
	public Long2IntMap(final int initialCapacit) {
    ...
    {
		if(!(o instanceof Long2IntMap)) {
			return false;
		}
		
		Long2IntMap map2 = (Long2IntMap)o;
        if (this == map2)
        {
            return true;
        }
        ...
        for (int i = 0, length = values.length; i < length; i++)
        {
            ...
            {
                final int thatValue = map2.get(keys[i]);
